...
('Alice Nguyen', 'alice@example.com', '$2y$12$L6VJ7Q8WBEXAMPLEziejr1enlVVwZjPU6YewsG32IOzBSSo4mF', 'Experienced guitar teacher focused on beginner musicians.', 'Austin, TX', 'assets/images/profile-alice.png'),
('Ben Carter', 'ben@example.com', '$2y$12$R4nQc7Lw9PRETENDHASHnmm4Y315IziwheZZz4jo5uZ5lFwfqVV', 'Frontend engineer offering React pair-programming and reviews.', 'Remote', 'assets/images/profile-ben.png'),
...
('Music', 'music', 'Lessons and jam sessions for instruments and vocals.', 'assets/images/category-music.png'),
('Programming', 'programming', 'Coding mentorship, debugging, and reviews.', 'assets/images/category-programming.png'),
('Art & Design', 'design', 'Illustration, UX, and visual storytelling.', 'assets/images/category-design.png'),
('Wellness', 'wellness', 'Yoga, fitness, and wellbeing guidance.', 'assets/images/category-wellness.png');

INSERT INTO `skill_posts` (`user_id`, `category_id`, `title`, `description`, `location`, `price_min`, `price_max`, `images`, `status`) VALUES
(1, 1, 'Beginner Acoustic Guitar Lessons', 'Two 45-minute sessions per week covering chords, rhythm, and learning your first songs.', 'Austin, TX', 20.00, 40.00, '["assets/images/post_guitar_1.png"]', 'active'),
(2, 2, 'React Pair-programming & Testing', 'Hands-on code review, component architecture best practices, and unit testing setup.', 'Remote', 35.00, 70.00, '["assets/images/post_react_1.png"]', 'active'),
(3, 3, 'UX Portfolio Critique', 'One-on-one critique sessions with actionable feedback on flows, visuals, and storytelling.', 'Denver, CO', 0.00, 0.00, '["assets/images/post_ux_1.png"]', 'active');
